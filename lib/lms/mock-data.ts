...
export const liveSessions: LiveSession[] = [
  ...
  },
  {
    ...
    recordingStatus: "pending",
    recurrenceRule: "FREQ=WEEKLY;BYDAY=MO",
    seriesId: "series-fillers-weekly",
    quiz: {
      id: "eq-fillers-1",
      title: "Fillers safety recap",
      passPercent: 66,
      isRequired: false,
      questionCount: 5,
    },
  ...
  {
    id: "live-3",
    title: "Alternate-day Peels Clinic Review",
    instructor: "Dr. Arjun Reddy",
    date: "Aug 10, 2026",
    time: "4:00 PM",
    duration: "1 hour",
  ...
  },
  {
    ...
    seriesId: "series-lasers-weekly",
  },
  {
    id: "live-past-1",
    title: "Live Class Recording: Botox Complications Q&A",
    instructor: "Dr. Priya Menon",
    date: "Jul 20, 2026",
    time: "3:00 PM",
    duration: "1 hour",
    ...
    attendees: 6,
    platform: "zoom",
    meetingUrl: "https://zoom.us/j/past-session",
    treatmentId: "botox",
    recordingStatus: "ready",
    recordingVideoId: "botox-live-rec-1",
    recordingTitle: "Live recording — Botox complications Q&A",
    recurrenceRule: "FREQ=WEEKLY;BYDAY=MO",
    seriesId: "series-botox-weekly",
    attachments: [
      {
        id: "att-1",
        fileName: "Case slides — vascular events.pdf",
        fileUrl: "#",
      ...
      {
        id: "att-2",
        fileName: "Staff clinical notes.pdf",
        fileUrl: "#",
        mimeType: "application/pdf",
        sizeLabel: "840 KB",
      },
    ...
    quiz: {
      id: "eq-botox-live-1",
      title: "Live class assessment",
      passPercent: 66,
      isRequired: false,
      questionCount: 4,
    },
    quizAttemptPassed: true,
  },
  {
    id: "live-past-2",
    title: "Live Class Recording: Peel Protocol Walkthrough",
    instructor: "Dr. Arjun Reddy",
    date: "Jul 13, 2026",
    time: "4:00 PM",
    duration: "1 hour",
    ...
    attendees: 5,
    platform: "zoom",
    meetingUrl: "https://zoom.us/j/past-session-2",
    treatmentId: "chemical-peels",
    ...
    attachments: [
      {
        id: "att-3",
        fileName: "Peel depth reference chart.pdf",
        fileUrl: "#",
        sizeLabel: "1.2 MB",
      },
    ],
